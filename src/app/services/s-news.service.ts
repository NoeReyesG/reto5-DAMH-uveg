...
export class SNewsService {
  allNews: New[] = [
    {
      ...
      y la vaquita marina, que vive en el Oceano y no tiene que ver, pero bueno, quién soy yo para negarme a dar buenas noticias.`
    }
  ]
  constructor() { }
  ...
  deleteNews(idNew: number){
    this.allNews.splice(idNew, 1);
  }
}
